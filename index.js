...
var fbuserid = event.sender.id;
        if (event.message && event.message.text) {
          ...
          if(prpos!=-1){ rate = ratearr[prpos]; 
                ...
                botmsg =event.message.text+" "+fbuserfname +"! "+"I am Zbot. I am designed to serve your business needs. Please choose the appropriate option below to boot your operating system.";
